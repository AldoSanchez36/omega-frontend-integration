...
export default function Profile() {
  // Only destructure the values we need now that editing is removed
  ...
  // Removed editing functionality; profile is read-only

  // Removed handleChange and handleSubmit since editing is disabled
          ...
          <div className=" mx-auto">
            ...
            <div className="card mb-4">
              ...
              <div className="card-body p-4">
                ...
                {/* Fin header visual */}
                {/* Read-only profile view; editing removed */}
                <div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                      <span className={`badge bg-${user.puesto === "admin" ? "danger" : "primary"}`}>{user.puesto}</span>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <div className="col-sm-3">
